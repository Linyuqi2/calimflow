...
save_filename        = 'gcamp6sVolume';                                    % Pick a file to save the simulated movie as (ends with either .fits, .tif, or .mat)
...
spike_opts.prot      = 'GCaMP6s';                                          % Set the indicator to GCaMP6s
