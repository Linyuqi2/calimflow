...
vol_params.vol_depth = 600;                                                % Set the depth of imaging (depth at the middle of the simulated volume)
save_filename        = ['deepVolume',num2str(vol_params.vol_depth),'um80mW'];  % Pick a file to save the simulated movie as (ends with either .fits, .tif, or .mat)
...
tpm_params.pavg      = 80;                                                 % power in units of mW
spike_opts.nt        = 10000;                                              % Set number of time step
