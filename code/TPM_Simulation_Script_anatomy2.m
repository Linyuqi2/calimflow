...
save_filename        = ['anatVol_scale',num2str(100*scaleVal),...
                                        '_density',num2str(100*scaleDen)]; % Pick a file to save the simulated movie as (ends with either .fits, .tif, or .mat)
vol_params.vol_sz    = [500,500,100];                                      % Volume size to sample (in microns)
vol_params.vol_depth = 200;                                                % Set the depth of imaging (depth at the middle of the simulated volume)
...
spike_opts.nt        = 20000;                                              % Set number of time step
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% load previously calculated neural volume & PSF struct

m = matfile([save_path,save_filename,'/',save_filename,'.mat']);
