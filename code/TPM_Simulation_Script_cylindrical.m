...
save_filename        = 'cylindricalLens';                                  % Pick a file to save the simulated movie as (ends with either .fits, .tif, or .mat)
...
psf_params.objNA     = 0.6;                                                % Numerical aperture of PSF
psf_params.NA        = 0.6;                                                % Numerical aperture of PSF
tpm_params.pavg      = 20;                                                 % power in units of mW
...
psf_params.type      = 'cylindrical';
psf_params.cylscale  = [0.5 1];                                           % Stretch PSF in one dimension
psf_params.psf_sz    = [30 40 50];
...
psf_params.type        = 'cylindrical';
psf_params.cylscale  = [0.02 1];                                           % Stretch PSF in one dimension
psf_params.psf_sz     = [30 40 50];
