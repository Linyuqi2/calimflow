...
save_path            = '/home/adam/BigStorage/Data/NAOMi/smallSimForStephen';% Set the directory to save results to
save_filename        = 'smallVolume40mW';                                % Pick a file to save the simulated movie as (ends with either .fits, .tif, or .mat)
