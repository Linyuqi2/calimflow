...
save_filename        = 'sparseLabelingVolume';                             % Pick a file to save the simulated movie as (ends with either .fits, .tif, or .mat)
...
spike_opts.p_off     = 0.85; % SPARSE LABELING: 80% of neurons do not express the indicator 
